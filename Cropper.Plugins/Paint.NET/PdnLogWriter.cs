...
{
    public class PdnLogWriter
    {
        private const string _fileName = "Paint.NET.xml";
        private XmlNode _imagesRoot;
        private string _saveFilePath;
        private XmlDocument _xdoc;

        public PdnLogWriter(string directory)
        {
            ...
            {
                string text1 = "type='text/xsl' href='CropperLog.xsl'";
