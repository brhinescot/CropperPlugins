...
namespace AviFile
{
	public class AudioStream : AviStream
	{
		...
		/// <summary>Read the stream's header information</summary>
		/// <returns>AVISTREAMINFO</returns>
		internal Avi.AVISTREAMINFO GetStreamInfo()
		{
			if (writeCompressed)
			{
		...
		internal Avi.PCMWAVEFORMAT GetFormat()
		{
		...
		internal IntPtr GetStreamData(ref Avi.AVISTREAMINFO streamInfo, ref Avi.PCMWAVEFORMAT format, ref int streamLength)
		{
